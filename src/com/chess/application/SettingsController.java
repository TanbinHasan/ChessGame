...
public class SettingsController extends SceneController {
	...
	public void initialize(URL location, ResourceBundle resources) {	
		...
		super.settings = new Setting(true, Mode.MANUAL_ONLY, PieceValues.SUPERSUPERHARD, Difficulty.SUPERSUPERHARD);
		selectWhite();
		populateComboBoxe();
		populateSlider();
		prepareCSS();
	...
	// ---------------------------------- INITIALIZATION HELPERS ----------------------------------
 	...
 	private void populateComboBoxe() {
 		modeChoice.getItems().addAll(Mode.MANUAL_ONLY.get());
 		modeChoice.getSelectionModel().select(Mode.MANUAL_ONLY.get());
 	}
